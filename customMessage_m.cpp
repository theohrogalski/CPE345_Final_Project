...
void customMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->gate_num);
    doParsimPacking(b,this->uncertainty);
}
...
void customMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->gate_num);
    doParsimUnpacking(b,this->uncertainty);
}

int customMessage::getMessage_type() const
{
    return this->message_type;
}

void customMessage::setMessage_type(int message_type)
{
    this->message_type = message_type;
}

int customMessage::getGate_num() const
{
    return this->gate_num;
}

void customMessage::setGate_num(int gate_num)
{
...
unsigned int customMessageDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_gate_num
        FD_ISEDITABLE,    // FIELD_uncertainty
    };
...
int customMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "gate_num") == 0) return baseIndex + 1;
    if (strcmp(fieldName, "uncertainty") == 0) return baseIndex + 2;
...
omnetpp::cValue customMessageDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_gate_num: return pp->getGate_num();
        case FIELD_uncertainty: return pp->getUncertainty();
